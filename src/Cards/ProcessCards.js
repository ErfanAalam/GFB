  ...
  return (
    <div>
      <div className=' w-[100%] md:w-[300px]  text-center  text-black '>
        <div className='h-[652px] w-[280px] md:w-[300px] relative flex flex-col items-center justify-end bg-cover bg-center gap-10 rounded-[60px] ' style={{ backgroundImage: `url(${src})` }}>
