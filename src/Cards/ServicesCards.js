...
const ServicesCards = ({title,src, mdstyle, smstyle}) => {
  return (
    <div className='h-[685px] w-[100%] md:w-[300px] text-center '>
      <button className={`w-[170px]  md:w-[200px] ${smstyle} md:${mdstyle} shadow-inner shadow-gray-600 p-1 text-[20px] md:text-[24px] mb-0 relative md:top-0 top-6 md:mb-14 tracking-tight leading-6 rounded-[15px] bg-[rgb(29,30,36)]`}>{title}</button>
