...
const ServicesCards = ({title,src}) => {
  return (
    <div className='h-[685px] w-[100%] md:w-[300px] text-center '>
      <button className=' w-[160px]  md:w-[240px] py-0 shadow-inner shadow-white p-1 text-[20px] md:text-[24px] mb-0 relative md:top-0 top-6 md:mb-14 tracking-tight leading-8 rounded-lg bg-[rgb(29,30,36)]  '>{title}</button>
