...
const Index = () => {
  ...
  return (
    <main className='bg-cover pb-10 bg-black flex flex-col items-center md:items-start' style={{ backgroundImage: "url('/Assets/Home/Hero.png')" }}>
      <h1 className={`text-[#EF6E16] text-[28px] md:text-[86px] mb-6 w-[100%] md:w-[1200px] text-center md:text-left px-6  md:px-[100px] font-[800]  pt-[190px] h-[342px] leading-[44px] md:leading-[104px] tracking-[2px]  md:tracking-[6px]`}><span className='text-white' >G</span>uided by expertise <span className='text-white' >F</span>ueled by passion <span className='text-white' >B</span>uilt on trust</h1>
