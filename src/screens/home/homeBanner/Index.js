...
const Homebanner = () => {
  ...
  return (
    <main id='homebanner' className='md:bg-cover bg-cover pb-24 bg-gray-800 flex flex-col items-center gap-8' style={{ backgroundImage: "url('/Assets/Home/Hero.png')" }}>
      ...
      <div className={`text-[${colors.mainTextColor}] text-[30px] md:text-[46px] lg:text-[76px]  w-[100%] text-center  px-2  pt-[140px] leading-[44px] md:leading-[104px] tracking-[2px]  md:tracking-[4px]`}>
      ...
      <div className='text-white text-[20px] md:text-[30px] lg:text-[36px] w-[100%]  text-center  md:leading-[60px] tracking-[2px]'>
