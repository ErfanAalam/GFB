...
const Index = () => {
  ...
  return (
    <main className='bg-cover pb-10 bg-black  ' style={{ backgroundImage: "url('/Assets/Home/Hero.png')" }}>
      ...
      <p className={`text-[${colors.mainTextColor}] text-[20px] md:text-[24px] md:mt-[100px] font-[700] w-[190px] md:w-[225px] ml-[30%] md:ml-[100px] p-2 bg-black bg-opacity-70  h-[48px] leading-[31.35px] border-2 `}>Free Consultation</p>
