...
const Homebanner = () => {
  ...
  return (
    <main id='homebanner' className='bg-cover pb-10 bg-gray-800 flex flex-col items-center ' style={{ backgroundImage: "url('/Assets/Home/Hero.png')" }}>
      <h1 className={`text-[${colors.mainTextColor}] text-[38px] md:text-[46px] lg:text-[76px]  w-[100%]  text-center  px-2 md:w-[90%] lg:w-[100%] xl:w-[80%] 2xl:w-[45%] pt-[170px] leading-[44px] md:leading-[104px] tracking-[2px]  md:tracking-[6px]`}><span className='text-white' >G</span>uided by expertise <span className='text-white' >F</span>ueled by passion <span className='text-white' >B</span>uilt on trust</h1>
