        ...
        <div className='overflow-hidden flex w-[64px] justify-between absolute left-[41%] xsm:left-[42%] 2xsm:left-[44%] top-[-30px] md:hidden z-[60]' >
         ...
         <div className='overflow-hidden md:flex w-[64px] justify-between absolute left-[48.4%]  top-[-30px] hidden  z-[60]' >
          ...
          <div className='mt-0 md:mt-20 relative z-[80]'>
            ...
            <button className=' py-2 w-[250px] z-20  md:w-[240px] shadow-inner shadow-gray-600 p-1 text-white text-[24px] md:text-[24px] mb-0 absolute md:top-10 top-10 md:left-8 left-2 md:mb-14 tracking-wide leading-8 rounded-[15px] bg-[rgb(29,30,36)]'>Construction</button>
          ...
          <div className=' relative z-[80] '>
            ...
            <button className=' py-2 w-[250px] z-20  md:w-[240px] shadow-inner shadow-gray-600 p-1 text-white text-[24px] md:text-[24px] mb-0 absolute md:top-20 top-32 left-2 md:left-[-18px] md:mb-14 tracking-wide leading-8 rounded-[15px] bg-[rgb(29,30,36)]'>Post-Construction</button>
