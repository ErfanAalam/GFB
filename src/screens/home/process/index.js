  ...
  return (
    <div>
      <section className='bg-[rgb(29,30,36)] text-white text-center'>
        ...
        <div className='bg-cover  z-10 relative flex flex-wrap md:flex-row flex-col items-center justify-evenly md:p-20 pb-10' style={{ backgroundImage: "url('/Assets/Home/bg/process.png')" }}>
          <div className='mt-20 md:mb-0 mb-20 relative '>
            <span className='absolute md:top-10 top-20 left-24 md:left-16 text-[34px]  text-orange-700 z-20'>01</span>
            <button className=' py-2 w-[250px] z-20  md:w-[240px] shadow-md shadow-white p-1 text-white text-[24px] md:text-[24px] mb-0 absolute md:top-20 top-32 left-24 md:left-16 md:mb-14 tracking-wide leading-8 rounded-lg bg-[rgb(29,30,36)]  '>Pre-Construction</button>
          ...
          <div className='relative'>
            <span className='absolute md:top-60 top-60 left-44 text-[34px]  text-orange-700 z-20'>02</span>
          ...
          <span className='absolute md:top-10 top-20 left-44 text-[34px]  text-orange-700 z-20'>03</span>
