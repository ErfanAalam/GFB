      ...
      <section className='bg-[rgb(29,30,36)] text-white text-center relative'>
        ...
        <div className='bg-cover bg-center z-10 relative flex flex-wrap md:flex-row flex-col items-center justify-evenly px-10  md:p-20 pb-10 gap-20 py-10' style={{ backgroundImage: "url('/Assets/Home/bg/process.png')" }}>
          ...
          <div className='mt-0 md:mt-20 relative z-30'>
            ...
            <button className=' py-2 w-[250px] z-20  md:w-[240px] shadow-inner shadow-gray-600 p-1 text-white text-[24px] md:text-[24px] mb-0 absolute md:top-20 top-40 left-8 md:mb-14 tracking-wide leading-8 rounded-lg bg-[rgb(29,30,36)]'>Construction</button>
