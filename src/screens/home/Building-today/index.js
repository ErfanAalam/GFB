  ...
  return (
    <div id='building' className=' bg-[rgb(29,30,36)] text-white py-10 pb-32' >
      ...
      <div className=' flex md:flex-row flex-col justify-between relative' >
        ...
        <div className='left w-[100%] md:w-[45%] text-center md:text-left  p-6 md:p-6 pt-0 md:pt-20 mt-8 md:mt-0 text-[20px] md:text-[18px] lg:text-[18px] xl:text-[26px] 2xl:text-[28px]  z-30  bg-[rgb(29,30,36)] md:bg-transparent mb-0 flex flex-col justify-between'>
          <div >
            <p>
