    ...
    <div id='building' className=' bg-[rgb(29,30,36)] text-white pt-10' >
      ...
      <div className=' flex md:flex-row flex-col justify-between relative' >
        ...
        <div className='overflow-hidden flex w-[64px] justify-between absolute right-[10%] md:left-[48.4%] z-20 md:z-10' >
          <span className={`w-[4px] h-[1020px] 2xl:h-[2920px] md:h-[2420px]   bg-[${colors.mainTextColor}]`}>
        ...
        <div className='left w-[100%] md:w-[45%]  p-6 md:p-6 pt-0 md:pt-20 mt-8 md:mt-0 text-[25px] md:text-[16px] lg:text-[20px] xl:text-[30px] 2xl:text-[35px] relative z-30  bg-[rgb(29,30,36)] md:bg-transparent '>
          <p>
