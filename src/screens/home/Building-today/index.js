...
const Building = () => {
  return (
    <div className=' bg-[rgb(29,30,36)] text-white pt-10' >
      <h2 className='text-[26px] md:text-[40px] text-center font-[800] pb-2 '>Building Today, for Tomorrow</h2>
      ...
      <div className=' flex md:flex-row flex-col justify-between relative' >
        ...
        <div className='left w-[100%] md:w-[50%] p-6 md:p-10 pt-0 mt-8 md:mt-0 md:pt-20 text-[25px] relative z-10  bg-[rgb(29,30,36)] md:bg-transparent md:text-[35px] font-[400]'>
          <p>
