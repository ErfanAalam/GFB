...
const Services = () => {
    return (
        <section id='services' className='  bg-[rgb(29,30,36)] text-white pb-10  text-center'>
            <button className={`text-[${colors.textWhite}] border-y-0 text-[30px]  w-[300px] my-8 p-6 bg-black relative z-20 md:top-0 top-[140px] leading-[31.35px] border-2`}>SERVICES</button>
