...
const Services = () => {
    return (
        <section id='services' className='  bg-[rgb(29,30,36)] text-white p-0  text-center '>
            <button className={`text-[${colors.textWhite}] border-y-0 text-[32px] md:text-[28px] w-[250px] my-4 p-4 bg-black relative z-20 md:top-[-18px] top-[20px] leading-[31.35px] border-2`}>Services</button>
