      ...
      <div className='bg-[rgb(29,30,36)] flex pb-20 '>
        ...
        <div className='flex flex-col text-white w-[100%] md:w-[80%] md:px-0 px-4  py-10 gap-10'>
            ...
            <div className='flex flex-col items-center text-center gap-4'>
              <img src='Assets/Contact us/2.png' className='w-[50px] rounded-[40%]'/>
              <h1 className='text-[24px] md:text-[26px] text-[#EF6E16] tracking-normal md:tracking-[3px]'>How Do I Start My project with GFB?</h1>
            ...
            <div className='flex flex-col items-center text-center gap-4'>
            <img src='Assets/Contact us/2.png' className='w-[50px] rounded-[40%]'/>
              <h1 className='text-[24px] md:text-[26px] text-[#EF6E16] tracking-normal md:tracking-[3px]'>Do you provide consultation for both residential and commercial projects?</h1>
            ...
            <div className='flex flex-col items-center text-center gap-4'>
            <img src='Assets/Contact us/2.png' className='w-[50px] rounded-[40%]'/>
              <h1 className='text-[24px] md:text-[26px] text-[#EF6E16] tracking-normal md:tracking-[3px]'>Can I provide my own designs or sketches?</h1>
