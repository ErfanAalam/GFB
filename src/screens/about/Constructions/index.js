...
const Constructions = () => {
  return (
    <div id='constructions' className='bg-cover bg-center flex md:flex-row flex-col-reverse  relative justify-between p-4 md:py-[105px] py-8  pt-24 md:pt-36 md:p-4' style={{ backgroundImage: "url('Assets/Services/blur2.png')" }}>
      <img src='Assets/About us/Assets/2.png' className='md:block hidden absolute md:w-[80%] lg:w-[70%] top-[75%] md:top-[85%] lg:top-[80%] right-[380px] md:right-[80px] lg:right-[50px] xl:right-[150px] 2xl:right-[290px] z-10' />
