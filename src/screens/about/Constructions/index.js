...
const Constructions = () => {
  return (
    <div id='constructions' className='bg-cover bg-center flex md:flex-row flex-col-reverse  relative justify-between p-4 md:py-[75px] py-8 pt-24 md:pt-20 md:p-4' style={{ backgroundImage: "url('Assets/Services/blur2.png')" }}>
