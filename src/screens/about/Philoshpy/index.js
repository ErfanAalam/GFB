  ...
  return (
    <div id='philosiphy' className='bg-cover p-4 md:p-20 pb-10 md:pb-[100px] bg-black text-center relative text-white ' style={{ backgroundImage: "url('Assets/Services/blur0.jpg')" }}>
      ...
      <div className='flex flex-col items-center gap-2 mb-10'>
        ...
        <hr className='w-[53%] md:w-[60%] lg:w-[50%] xl:w-[30%] 2xl:w-[30%] border-t-4 border-t-white' />
      </div>
      ...
      <div>
        <p className='text-white text-[16px] md:text-2xl tracking-normal md:pt-0 pt-4 md:tracking-[4px] md:px-4 lg:px-8 xl:px-60 2xl:px-80 relative z-30'>GFB, short for “Go for Broke”, is more than just our name - it's the principle that guides us.
          <br /><br />
