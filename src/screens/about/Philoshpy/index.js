...
const Philoshphy = () => {
  return (
    <div id='philosiphy' className='bg-cover p-4 2xl:p-20 pb-10 2xl:pb-[100px] bg-black text-center relative text-white md:py-0 py-10' style={{ backgroundImage: "url('Assets/Services/blur0.jpg')" }}>
      <img src='Assets/About us/Assets/1.png' className='absolute hidden md:block top-[20%] md:top-[50%] lg:top-[20%] 2xl:top-[30%] right-[80px] md:right-[150px] 2xl:right-[360px] z-10'/>
