...
const Philoshphy = () => {
  return (
    <div className='bg-cover p-10 md:p-40 bg-black text-center text-white pb-32' style={{ backgroundImage: "url('Assets/Services/blur0.jpg')" }}>
      <div>
      ...
      <div className='flex justify-center'>
        <img src='Assets/About us/1.png'></img>
      </div>
      <div>
