...
const ChooseGfb = () => {
  return (
    <div id='Choose' className='bg-cover bg-center flex md:flex-row flex-col md:pt-20 pt-20 justify-around p-4 py-10 relative' style={{ backgroundImage: "url('Assets/Services/blur2.png')" }}>
      ...
      <div className='text-center flex flex-col w-[100%] md:w-[70%] md:ml-4 xl:ml-20 gap-10  xl:gap-20 items-center '>
        <div className='flex flex-col items-center md:static absolute top-0 pt-4 gap-2'>
