...
const ChooseGfb = () => {
  return (
    <div id='Choose' className='bg-cover bg-center flex md:flex-row flex-col md:pt-20 justify-around p-4 py-10 pt-48 relative' style={{ backgroundImage: "url('Assets/Services/blur2.png')" }}>
