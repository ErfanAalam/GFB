...
const ChooseGfb = () => {
  return (
    <div id='Choose' className='bg-cover bg-center bg-black flex md:flex-row flex-col md:pt-20 justify-around p-0 py-10 md:py-32 pt-48 relative'>
      ...
      <div className='absolute bottom-[-40px]  h-[106%] w-[100%] hidden md:block bg-[rgba(77,61,44,0.1)] opacity-100 backdrop-blur-[25px] blur-sm z-[2] shadow-integrated-shadow'></div>
      ...
      <div className='w-[100%] md:w-[40%] xl:w-[30%] relative md:z-30 flex justify-center z-[100]'>
        <img src='Assets/About us/3.png' className='w-[350px] xsm:w-[500px] md:h-[600px] lg:h-[600px] xl:h-[600px]'></img>
      </div>
      ...
      <div className='text-center flex flex-col w-[100%] md:w-[60%] ml-0 md:ml-10 xl:ml-10 gap-10 xl:gap-20 items-center pr-0 md:pr-20 z-[100]'>
        ...
        <p className='text-white text-[16px] md:text-[24px] lg:text-[30px] xl:text-2xl tracking-[4px] px-4 '>
