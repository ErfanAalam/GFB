  ...
  return (
    <div id='homebanner' className="bg-cover bg-center md:bg-top flex flex-col pt-24 md:py-0 md:pt-60 gap-0 " style={{ backgroundImage: "url('Assets/About us/about_usbg.jpeg')" }}>
      ...
      <div className='flex justify-center my-10'>
        <button className={`text-white md:w-[350px] text-4xl md:text-7xl md:h-[70px]`}>About Us</button>
      </div>
      <hr className={`w-[60%] border-t-4 border-[${colors.mainTextColor}] `} />
      <div className='overflow-hidden flex w-[100%] gap-4 justify-center ' >
        <span className={`w-[4px]  h-[100px]  md:h-[240px]  bg-[${colors.mainTextColor}]`}></span>
        <span className=' w-[4px]  h-[100px]  md:h-[240px] bg-black'></span>
        <span className=' w-[4px]  h-[100px]  md:h-[240px]  bg-white'> </span>
      </div>
    </div>
  )
}
