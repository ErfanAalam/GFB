...
const Homebanner = () => {
  return (
    <div id='homebanner' className="bg-cover flex flex-col py-24 md:py-0 md:pt-60 gap-0 bg-gray-800" style={{ backgroundImage: "url('Assets/About us/about_usbg.jpeg')" }}>
      <hr className={`w-[60%] ml-[40%] border-t-4 border-[${colors.mainTextColor}] hidden md:block`} />
      <div className='flex justify-center my-10'>
        <button className={`text-[${colors.mainTextColor}] md:w-[350px] text-7xl  md:h-[100px]`}>About Us</button>
      </div>
