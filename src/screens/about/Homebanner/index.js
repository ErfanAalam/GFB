...
const Homebanner = () => {
  return (
    <div id='homebanner' className="bg-cover bg-center md:bg-top flex flex-col py-24 md:py-0 md:pt-60 gap-0 " style={{ backgroundImage: "url('Assets/About us/about_usbg.jpeg')" }}>
