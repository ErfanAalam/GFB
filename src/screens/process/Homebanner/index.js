...
const Homebanner = () => {
  return (
   ...
   <hr className={`w-[60%] ml-[40%] border-t-4 border-[${colors.mainTextColor}] block`} />
      <div className='flex justify-center my-2'>
        <button className={`text-white md:w-[350px] text-[40px] md:text-[80px] `}>Process</button>
      </div>
      <hr className='w-[60%] border-t-4 border-orange-500 block' />
