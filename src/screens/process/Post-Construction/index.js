...
const PostConstruction = () => {
  return (
    <div id='postConstruction' className='bg-gray-200 flex relative'>
        ...
        <img src='Assets/Contact us/2.png' className='w-[30px] absolute md:top-[200px] top-[350px] left-[53px] md:left-[125px] z-[60] bg-gray-200' />
        <img src='Assets/Contact us/2.png' className='w-[30px] absolute md:top-[600px] top-[950px] left-[53px] md:left-[125px] z-[60] bg-gray-200' />
