    ...
    <div className='bg-gray-200 flex  '>
      ...
      <div id='preconstruction' className='overflow-hidden flex w-[64px] mx-2 md:mx-20 relative z-40 justify-between  ' >
        <span className='w-[4px] h-[100%] bg-black'>
          ...
          <img src='Assets/Contact us/2.png' className='absolute  bottom-20 left-0' />
      ...
      <div className='p-2 md:p-4 xl:p-20 w-[80%] mt-4 flex flex-col gap-4 md:gap-8'>
        ...
        <div className='flex m-0 md:ml-4 lg:ml-20 md:flex-row md:pt-0 pt-10 flex-col-reverse justify-between items-center relative '>
          <div className='w-[100%] md:w-[90%] xl:w-[90%]'>
            <h1 className={`text-[20px] md:text-[30px] xl:text-3xl text-[${colors.mainTextColor}] md:static absolute top-[-10px]`}>1. Consultation & Discovery</h1>
        ...
        <div className='flex m-2 md:ml-0 lg:ml-2 md:pt-0 pt-10 md:flex-row flex-col justify-between items-center relative'>
          ...
          <div className='w-[100%] md:w-[90%] lg:w-[70%] xl:w-[90%]'>
            <h1 className={`text-[20px] md:text-3xl text-[${colors.mainTextColor}] md:static absolute top-[-10px]`}>2. Design & Planning</h1>
        ...
        <div className='flex m-2 md:ml-4 lg:ml-20 md:pt-0 pt-10 md:flex-row flex-col-reverse justify-between items-center relative '>
          <div className='w-[100%] md:w-[70%] xl:w-[90%]'>
            <h1 className={`text-[20px] md:text-3xl text-[${colors.mainTextColor}] md:static absolute top-[-10px]`}>3. Permitting & Approvals</h1>
