...
const Homebanner = () => {
  return (
    <div className="bg-cover  flex flex-col pt-56 gap-0 bg-black" style={{ backgroundImage: "url('Assets/Services/hero.png')" }}>
      <hr className='w-[60%] ml-[40%] border-t-4 border-orange-500' />
      <div className='flex justify-center my-10'>
        <button className='text-orange-500 shadow-md shadow-orange-400 bg-none bg-blend-multiply md:bg-white md:w-[350px] text-6xl  md:h-[100px]'>Services</button>
      </div>
