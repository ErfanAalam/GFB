...
const Homebanner = () => {
  return (
    <div id='homebanner' className="bg-cover  flex flex-col pt-56 gap-0 bg-black" style={{ backgroundImage: "url('Assets/Services/hero.png')" }}>
      <hr className={`w-[60%] ml-[40%] border-t-4 border-[${colors.mainTextColor}]`} />
      <div className='flex justify-center my-4'>
        <button className={`text-[${colors.mainTextColor}]  md:w-[350px] text-6xl  md:h-[100px]`}>Services</button>
      </div>
