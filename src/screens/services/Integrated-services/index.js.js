...
const Integrated = () => {
  return (
    ...
    <div id='integrated' className='relative  bg-cover bg-black bg-center text-white pb-10 overflow-visible'>
      ...
      <img src='Assets/Services/Group 3620.png' alt='group 3620' className='hidden md:block absolute top-[20%] md:top-[33%] left-[35%] xsm:left-[42%] 2xsm:left-[38%] 3xsm:left-[36%] md:left-28 lg:left-40 xl:left-44 2xl:left-[-9%]  z-20 md:z-20 h-[400px] xsm:h-[550px] md:h-[123%] lg:h-[112%] md:w-[70%] lg:w-[72%] xl:w-[75%] 2xl:w-[92%]' />
      ...
      <div className='flex md:flex-row flex-col relative items-center gap-0 md:gap-40 2xl:gap-40 md:p-4 lg:p-20 2xl:p-20 p-6 md:pt-0 pt-32'>
        ...
        <div className='w-[100%] md:w-[95%] lg:w-[80%] xl:w-[70%] 2xl:w-[60%] md:py-10 py-0 md:pt-0 lg:pt-10 xl:pt-20  pt-10  px-0 md:px-0 lg:px-2 xl:px-18 2xl:px-24'>
          ...
          <p className='text-[20px] md:text-[22px] 2xl:text-[28px] relative z-50 text-center md:text-left'>Our in-house Architects, Electricians, and Engineers help provide a seamless experience for you and your project.
            <br /> <br />
