...
const Integrated = () => {
  return (
    ...
    <div id='integrated' className='relative  bg-cover bg-black bg-center text-white pb-10 overflow-visible'>
      ...
      <img src='Assets/Services/Group 3620.png' alt='group 3620' className='hidden md:block absolute top-[20%] md:top-[33%] left-[35%] xsm:left-[42%] 2xsm:left-[38%] 3xsm:left-[36%] md:left-28 lg:left-40 xl:left-44 2xl:left-[-4%]  z-20 md:z-20 h-[400px] xsm:h-[550px] md:h-[123%] lg:h-[112%] md:w-[70%] lg:w-[72%] xl:w-[75%] 2xl:w-[88%]' />
