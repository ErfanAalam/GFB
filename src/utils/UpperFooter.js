...
const UpperFooter = () => {
  return (
    <div className=' bg-center bg-contain md:bg-contain bg-no-repeat text-white flex justify-center items-center p-6  bg-[hsl(231,11%,13%)] leading-[20px] md:leading-[50px]' style={{ backgroundImage: "url('Assets/Home/bg/start your Bulding Journey.png')" }}>
      <div className='w-[100%] md:w-[710px] text-center flex flex-col items-center gap-4 mt-[150px] md:mt-[200px]'>
        ...
        <button className={`text-[${colors.textWhite}] mt-18 md:mt-10 text-[30px] w-[325px] md:w-[625px]  p-2 bg-black bg-opacity-70  h-[58px] leading-[31.35px] border-2 border-[#EF6E16] `}>Start Your Project</button>
      </div>
