...
const UpperFooter = () => {
  ...
  return (
    <div id='startjourney' className=' bg-center bg-cover md:bg-cover lg:bg-cover 2xl:bg-contain bg-no-repeat text-white flex justify-center items-center p-6  bg-[hsl(231,11%,13%)] leading-[20px] md:leading-[50px]' style={{ backgroundImage: "url('Assets/Home/bg/start your Bulding Journey.png')" }}>
